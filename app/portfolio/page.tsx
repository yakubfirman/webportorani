...
import { PortfolioItemData, ContactInfoData, HeroData } from '@/types';
...
export const metadata: Metadata = {
  title: 'Semua Portfolio — Maharani Rizka Ramadhani Wijaya',
  description: 'Kumpulan lengkap dokumentasi kegiatan mengajar, silabus, dan karya pengembangan pembelajaran.',
...
export default async function PortfolioPage() {
  const [portfolioItems, contact, hero] = await Promise.all([
  ...
  // Sort portfolio items by order (descending - latest first)
  const sortedItems = portfolioItems?.sort((a, b) => (b.order ?? 0) - (a.order ?? 0)) ?? [];
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                Dokumentasi lengkap kegiatan mengajar, silabus, dan karya pengembangan pembelajaran
              </p>
            </div>
          </div>
        </section>
